...
public class AplicacaoCliente extends UnicastRemoteObject implements InterfaceCliente {
    ...
    public static void conexao() {
        try {
            ...
            interfaceServidor.insereMoeda("Dólar Comercial", "3.822");
            interfaceServidor.insereMoeda("Dólar Turismo", "3.670");
            interfaceServidor.insereMoeda("Dólar PTAX800", "3.834");
            interfaceServidor.insereMoeda("Euro", "4.302");
            interfaceServidor.insereMoeda("Franco Suíço", "3.826");
            interfaceServidor.insereMoeda("Peso Argentino", "0.089");
            interfaceServidor.insereMoeda("Libra Esterlina", "5.021");
            interfaceServidor.insereMoeda("Dólar Canadense", "2.877");
            interfaceServidor.insereMoeda("Dólar Australiano", "2.740");
            interfaceServidor.insereMoeda("Africa Do Sul", "0.2818");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (Nome.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Insira o nome da moeda!");
                    } else if (Cotacao.getText().equals("")) {
                        JOptionPane.showMessageDialog(null, "Insira a cotação!");
                    } else {
